...
const textContent = {
    h2: 'Szolgáltatások ',
    p: 'Örömmel várjuk asztalfoglalásod, legyen az céges rendezvény, családi ünnep vagy baráti összejövetel. Mi biztosítjuk a finom ételeket és a jó hangulatot!',
